...
const MarkDeliveredModal = ({ order, isOpen, onClose, onMarkDelivered }: MarkDeliveredModalProps) => {
  const { t } = useLanguage();
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload images to confirm delivery
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="deliveryImages">{t('uploadDeliveryImages')}</Label>
            <div className="mt-2 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
              <input
                ...
                className="hidden"
              />
              <label htmlFor="deliveryImages" className="cursor-pointer">
                <Upload className="h-8 w-8 mx-auto mb-2 text-gray-400" />
                <p className="text-sm text-gray-600">
                  Click to upload delivery verification images
                </p>
              </label>
            </div>
          </div>
